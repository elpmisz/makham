  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-body">
        <form action="/issue/auth" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="row mb-2">
            <label class="col-xl-4 col-form-label text-right">รายชื่อ</label>
            <div class="col-xl-6">
          ...
          <div class="row mb-2">
            <label class="col-xl-4 col-form-label text-right">สิทธิ์</label>
            <div class="col-xl-8">
              <div class="row pb-2">
                <div class="col-xl-4">
