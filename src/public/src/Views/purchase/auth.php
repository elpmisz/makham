  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-body">
        <form action="/purchase/auth" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="row mb-2">
...
<script>
  ...
  $(document).on("click", ".auth-delete", function(e) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        axios.post("/purchase/auth-delete", {
          id: id
        }).then((res) => {
          let result = res.data;
          if (result === 200) {
