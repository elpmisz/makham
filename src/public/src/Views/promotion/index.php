  ...
  <div class="col-xl-12">
    <div class="card shadow">
      <div class="card-header">
        <h4 class="text-center">ส่งเสริมการขาย</h4>
      </div>
      <div class="card-body">
        ...
        <div class="row justify-content-end mb-2">
          ...
          <div class="col-xl-3 mb-2">
            <a href="/promotion/download" class="btn btn-danger btn-sm btn-block">
              <i class="fas fa-download pr-2"></i>นำข้อมูลออก
            </a>
          </div>
          <div class="col-xl-3 mb-2">
            <a href="/promotion/create" class="btn btn-primary btn-sm btn-block">
        ...
        <div class="row mb-2">
          <div class="col-xl-12">
            <div class="table-responsive">
              <table class="table table-bordered table-hover promotion-data">
                <thead>
                  <tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
        <form action="/promotion/upload" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          <div class="row mb-2">
...
<script>
  ...
  function filter_datatable() {
    $(".promotion-data").DataTable({
      serverSide: true,
      searching: true,
      scrollX: true,
      order: [],
      ajax: {
        url: "/promotion/promotion-data",
        type: "POST",
      },
      columnDefs: [{
        targets: [0, 2, 3],
