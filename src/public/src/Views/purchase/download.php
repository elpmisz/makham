...
$columns = ["เลขที่เอกสาร", "ผู้ทำรายการ", "รายชื่อลูกค้า", "จำนวนที่ผลิต", "จำนวนตู้", "ตู้ละ", "วันที่ผลิต", "วันที่ส่งลูกค้า", "เลขที่ใบเบิก", "วัตถุประสงค์", "วัตถุดิบ", "คลัง", "ห้อง", "ปริมาณ (เป้าหมาย)", "ปริมาณ (ผลิต)", "หน่วยนับ", "สถานะ", "วันที่"];
