...
$columns = ["UUID", "ชื่อ", "เลขที่ภาษี", "อีเมล", "ติดต่อ", "ที่อยู่", "ตำบล/เขต", "อำเภอ/แขวง", "จังหวัด", "รหัสไปรษณีย์", "รายละเอียด", "สถานะ", "วันที่ล่าสุด"];
