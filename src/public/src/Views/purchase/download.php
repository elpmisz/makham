...
$columns = ["UUID", "ผู้ทำรายการ", "สูตรการผลิต", "เครื่องจักร", "จำนวนที่ผลิต (เป้าหมาย)", "จำนวนที่ผลิต (จริง)", "วันที่ผลิต", "วัตถุดิบ", "ปริมาณ (ที่ใช้)", "วัตถุประสงค์", "สถานะ", "วันที่ล่าสุด"];
