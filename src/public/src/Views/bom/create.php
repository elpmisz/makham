...
<div class="row">
  <div class="col-xl-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="/bom/create" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                ...
                <table class="table table-bordered table-sm item-table">
                  ...
                  <tbody>
                    <tr class="item-tr">
                      ...
                      <td>
                        <input type="number" class="form-control form-control-sm text-center" name="product_quantity[]" min="0" step="0.01" required>
                        <div class="invalid-feedback">
                          กรุณากรอกข้อมูล!
                        </div>
                      </td>
